...
<div>
    <v-card color="white" elevation="0">
        ...
        <v-row justify=""  class="">
            <v-col cols="12" sm="12" md="12">
                <div class="container">
                    <div class="">
                        <v-btn color="black" rounded style="color: white; margin: 12px" to="/addEstate">
            ...
            <v-col cols="12" sm="6" md="6">
                <div class="container">
                    <div class="d-flex" style="margin: 12px">
                        <v-text-field width="200" style="margin: 12px" v-model="estates_search" @change="searchEstate(estates_search)" placeholder="Search for estates" filled rounded clearable dense>
                        </v-text-field>
                        <v-btn style="margin: 12px" fab x-small color="#b6ff00" @click="searchEstate(estates_search)">
                    ...
                    <v-container>
                        <div class="row text--center" id="all_items">
                            <div v-for="tag in estates" :key="tag.id" class="col-md-4">
                                <div class="container">
                                    <v-card elevation="0">
                                        <v-img :src="tag.estate_image" class="white--text align-end" gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height="200px">
                        ...
                        >
                                                ...
                                                <!-- <v-btn icon color="black" :to="`/estate/${tag.estate_id}`">
                            <v-icon color="black">mdi-user-multiple</v-icon>
                          </v-btn> -->
                                            </div>
                                        </div>
                                    </v-card>
                    ...
                    <v-col cols="12" sm="12" md="12" lg="12">
                        <div class="container">
                            <div>
                                ...
                                <div class="d-flex" style="margin: 12px">
                                    <v-text-field width="200" style="margin: 12px" v-model="pay_search" @change="searchPayments(pay_search)" placeholder="Search for payment" filled rounded clearable dense>
                                    </v-text-field>
                                    <v-btn style="margin: 12px" fab x-small color="black" @click="searchPayments(pay_search)">
                                ...
                                <v-list subheader three-line>
                                    <v-list-item-group active-class="pink--text" multiple>
                                        <template v-for="(item, index) in payments">
                                            <v-list-item :key="item.transaction_id">
                                                <template v-slot:default="{ active }">
                                                    <v-list-item-content>
                                                        <v-list-item-title v-text="item.estate_name"></v-list-item-title>

                                                        <v-list-item-subtitle class="text--primary" v-text="item.transaction_id"></v-list-item-subtitle>

                                                        <v-list-item-subtitle v-text="item.payment_method"></v-list-item-subtitle>
                                                ...
                                                moment(item.created_at).fromNow()
                                                    ...
                                                    <v-list-item-action>
                                                        <v-list-item-action-text v-text="item.amount_paid"></v-list-item-action-text>
                                                    </v-list-item-action>
                                                </template>
                                            </v-list-item>
    ...
    <v-row justify="space-around">
        <v-col cols="auto">
            ...
            <v-dialog v-model="dialogHs" transition="dialog-top-transition" max-width="600">
                <v-card>
                    <v-row>
                        <v-col cols="12" sm="6" md="6" lg="6">
                            <div>
            ...
            axios
                ...
                .then(function (response) {
                    if (response.status == 200) {
                        ...
                        that.payments = response.data;
                        that.totalRevenue = response.data.reduce((sum, payment) => sum + Number(payment.amount_paid), 0);
